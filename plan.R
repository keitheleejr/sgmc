...
g <- ganttAddTask(g, "Clean Data", "2023-10-16", "2023-10-17", done=100)
g <- ganttAddTask(g, "Add Levels to levels.R", "2023-10-16", "2023-10-17", done=100)
g <- ganttAddTask(g, "Functions", "2023-10-16", "2023-10-17", done=100)
g <- ganttAddTask(g, "EDA with ggplot2", "2023-10-18", "2023-10-22", done = 50)
...
plot(g, ylabel=list(font=font),
     event.time="2023-10-21", event.label="Report Date")
